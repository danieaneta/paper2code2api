"""FastAPI inference server for LeNet-5.
...
from infer import predict, load_model, WEIGHTS_PATH

app = FastAPI(
    title="paper2code2api · LeNet-5",
    description="Handwritten-digit classification (MNIST) from LeCun et al. 1998.",
    version="1.0.0",
)
